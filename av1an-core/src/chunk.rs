...
use crate::target_quality::PredictionMethod;
...
pub struct Chunk {
    ...
    /// Stores the history of (quantizer, prediction_method, score) probes.
    #[serde(default)]
    pub probe_history: Option<Vec<(u32, PredictionMethod, f64)>>,
}
